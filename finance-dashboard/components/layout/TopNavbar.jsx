      ...
      <div className="flex items-center gap-2 md:gap-4">
        <div className="relative group hidden sm:block">
          ...
          <input
            ...
            className="h-10 w-40 md:w-64 rounded-full border border-[oklch(0.25_0.02_260)] bg-[oklch(0.18_0.01_260)] pl-10 pr-4 text-sm text-[oklch(0.985_0_0)] placeholder:text-[oklch(0.65_0.01_260)] focus:border-[oklch(0.50_0.20_250)] focus:outline-none focus:ring-1 focus:ring-[oklch(0.50_0.20_250)] transition-all"
          />
        </div>
